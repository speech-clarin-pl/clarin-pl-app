...
export const SAVE_TRANSCRIPTION = 'SAVE_TRANSCRIPTION';
...
export const REPO_RUN_SPEECHSERVICE = 'REPO_RUN_SPEECHSERVICE';
export const REPO_RUN_SPEECHSERVICE_FAILED = 'REPO_RUN_SPEECHSERVICE_FAILED';
